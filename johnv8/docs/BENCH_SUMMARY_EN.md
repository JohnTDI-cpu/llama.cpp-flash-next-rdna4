...
**Quality (2 GPUs, this build):** evaluated on the author's Polish evaluation set and with a generation sanity test on the 2-GPU server — same quality as the stock build, correct and cleanly terminated answers, no loops or garbage.
