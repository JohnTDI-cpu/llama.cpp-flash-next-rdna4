...
**Quality check (2 GPUs, this build):** SpeakLeash / Open PL LLM Leaderboard tasks with `--limit 0.1` (108 items per task, thinking disabled, temp 0): average 83.95 (psc 90.74, ppc 75.93, dyk 82.41, belebele 93.52, 8tags 78.70, polemo2 82.41) vs 84.26 for the full 9101-sample run of the same model — within sampling error. Generation sanity (26 multi-sentence answers to logic/arithmetic questions, with and without thinking, 4 concurrent): all correct, no loops, no garbage.
